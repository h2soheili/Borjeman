...
<br/>
<br/>
<img src="src/image0.png"   width="350"/>
# operator:"chart"<br/>
type: "unitstatus",<br/>
...
------------------------------------------------------------------------------------------------------------------------------
<img src="src/image1.png" width="350" />
# operator:"chart" <br/>
 type: "unitpercent",<br/>
 buildingID: buildingID,  //  شناسه ساختمانی که واحد در ان قرار دارد
<br/> unitID: ID, // شناسه واحد  
 ...
 ------------------------------------------------------------------------------------------------------------------------------
<img src="src/image2.png" width="350" />
...
------------------------------------------------------------------------------------------------------------------------------
<img src="src/image3.png" width="350" />
# operator:"getcostnot"<br/>
...
------------------------------------------------------------------------------------------------------------------------------
<img src="src/image4.png" width="350" />
...
chargeeffect:''<br/>
        ------------------------------------------------------------------------------------------------------------------------------  
<img src="src/image5.png" width="350" />
# operator:"getcost"<br/>
 ID: "",<br/>
 unitID: "",<br/>
 costID: "",<br/>
...
<br/>
------------------------------------------------------------------------------------------------------------------------------
<img src="src/image6.png" width="350" />
# operator:"getcostnot"<br/>
